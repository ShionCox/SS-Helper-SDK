...
- Runtime descriptor capabilities: `tavern.context.read`, `tavern.identity.read`, `tavern.character.read`, `tavern.persona.read`, `tavern.chat.read`, `tavern.chat.write`, `tavern.chat.events`, `tavern.prompt.contribute`, `tavern.plugin.request`, `tavern.plugin.binary-request.v0`, `tavern.generation.read`, `tavern.generation.execute`, `tavern.worldbooks.read`, `tavern.worldbooks.write`.
