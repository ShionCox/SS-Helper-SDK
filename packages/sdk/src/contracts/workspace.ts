...
export interface WorkspaceRecord { readonly recordId: string; readonly value: PlainData; readonly version: number; readonly revision?: number; readonly updatedAt: number; }
...
export interface WorkspaceRecordRequest { readonly workspaceId: string; readonly ownerPluginId?: string; readonly collection?: string; readonly recordId: string; readonly value?: PlainData; readonly expectedVersion?: number; readonly expectedRevision?: number; }
...
export type WorkspaceTransactionOperation =
  | { readonly action: 'upsert'; readonly collection?: string; readonly recordId: string; readonly value: PlainData; readonly expectedVersion?: number; readonly expectedRevision?: number }
  | { readonly action: 'delete'; readonly collection?: string; readonly recordId: string; readonly expectedVersion?: number; readonly expectedRevision?: number };
...
export interface WorkspaceTransactionResult { readonly operationCount: number; readonly replayed: boolean; readonly results: readonly { readonly collection: string; readonly recordId: string; readonly action: 'upsert' | 'delete'; readonly version?: number; readonly revision?: number; readonly removed?: boolean }[]; }
